...
const Header = () => {
    return (
        <div className='border-2 border-gray-700 sticky top-1'>
            <header className="p-2 dark:bg-gray-800 dark:text-gray-100">
                <div className="container flex justify-between h-16 mx-auto">
                    ...
                    <ul className="items-stretch hidden space-x-3 md:flex">
                        ...
                        <li className="flex">
                            <Link rel="noopener noreferrer" to='/corse' className="flex items-center px-4 -mb-1 border-b-2 dark:border-transparent">Courses</Link>
                        </li>
                        <li className="flex">
